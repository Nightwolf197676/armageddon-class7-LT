...
resource "aws_cloudfront_distribution" "bos_cf01" {
  enabled         = true
  ...
  origin {
    ...
    domain_name = aws_lb.bos_alb01.dns_name
    ...
    custom_header {
      name  = "X-BOS-Growl"
      value = random_password.bos_origin_header_value01.result
    }
  }
  ...
  viewer_certificate {
    acm_certificate_arn      = aws_acm_certificate.bos_acm_cert01.arn
